  ...
  */
  ...
  (function injectStyles() {
    ...
    style.textContent = [
      ...
      '.tayanch-google-fallback{border:1px solid var(--border,#3a3b47);background:var(--surface,#1b1b22);color:var(--text,#e8e8ef);border-radius:999px;padding:9px 16px;font:600 14px/1 system-ui,sans-serif;cursor:pointer;box-shadow:0 1px 3px rgba(0,0,0,.08)}',
      '.tayanch-google-fallback:hover{background:var(--panel2,#26272f)}',
