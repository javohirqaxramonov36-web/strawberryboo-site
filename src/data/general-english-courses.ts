...
export const generalEnglishCourses: readonly GeneralEnglishCourse[] = [
  ...
  },
  {
    ...
    ...localized(
      { title: 'General English — Upper-Intermediate (B2)', category: 'General English', tags: ['Til', 'General English'], description: 'Murakkab grammatika, argumentlarni tuzish, ish va o‘qishdagi muloqot, kengroq lug‘at hamda ilg‘or tinglash mashqlari bilan nutqingizni kuchaytiring.', targetAudience: 'O‘qish yoki ishdagi murakkabroq muloqotga tayyorlanayotgan B1 darajadagi o‘quvchilarga.', price: '$15 (≈ 187 500 so‘m)', badge: 'Yangi' },
      { title: 'General English — Upper-Intermediate (B2)', category: 'Общий английский', tags: ['Язык', 'Общий английский'], description: 'Усильте речь с помощью сложной грамматики, построения аргументов, общения для работы и учёбы, более широкого словаря и продвинутого аудирования.', targetAudience: 'Учащимся уровня B1, готовящимся к более сложному общению в учёбе или работе.', price: '$15 (≈ 187 500 сум)', badge: 'Новый' },
      { title: 'General English — Upper-Intermediate (B2)', category: 'General English', tags: ['Language', 'General English'], description: 'Strengthen your English with complex grammar, argument building, communication for work and study, broader vocabulary, and advanced listening practice.', targetAudience: 'B1 learners preparing for more demanding communication in study or work.', price: '$15 (≈ 187,500 UZS)', badge: 'New' }
    )
  },
  {
    slug: 'general-english-advanced', cefr: 'C1', certificate: true, accent: '#a855f7', previousSlug: 'general-english-upper-intermediate',
    ...localized(
      { title: 'General English — Advanced (C1)', category: 'General English', tags: ['Til', 'General English'], description: 'Professional va akademik vaziyatlarda nozik ma’nolarni yetkazing: murakkab nutq, taqdimot, ilg‘or lug‘at va yuqori darajadagi tinglash ustida ishlang.', targetAudience: 'Murakkab akademik yoki professional muloqotda aniq va ishonchli gapirishni maqsad qilganlarga.', price: '$15 (≈ 187 500 so‘m)', badge: 'Yangi' },
      { title: 'General English — Advanced (C1)', category: 'Общий английский', tags: ['Язык', 'Общий английский'], description: 'Передавайте тонкие смыслы в профессиональных и академических ситуациях: работайте со сложной речью, презентациями, продвинутой лексикой и аудированием высокого уровня.', targetAudience: 'Тем, кто стремится говорить точно и уверенно в сложном академическом или профессиональном общении.', price: '$15 (≈ 187 500 сум)', badge: 'Новый' },
      { title: 'General English — Advanced (C1)', category: 'General English', tags: ['Language', 'General English'], description: 'Convey nuance in professional and academic settings through complex speaking, presentations, advanced vocabulary, and high-level listening practice.', targetAudience: 'Learners aiming to communicate precisely and confidently in demanding academic or professional contexts.', price: '$15 (≈ 187,500 UZS)', badge: 'New' }
    )
  }
];
